...
class MainActivity : AppCompatActivity() {
    ...
    private fun setViewElements() {
        ...
        when (lemonadeState){
            SELECT -> lemonImage?.setBackgroundResource(R.drawable.lemon_tree)
            SQUEEZE -> lemonImage?.setBackgroundResource(R.drawable.lemon_squeeze)
            DRINK -> lemonImage?.setBackgroundResource(R.drawable.lemon_drink)
            RESTART -> lemonImage?.setBackgroundResource(R.drawable.lemon_restart)
        }
